...
public class purchaseupdate1 extends JDialog {
	 ...
	 * 
	 */
	public purchaseupdate1() throws Exception {
		setResizable(false);
		...
		lblStudentid.setBounds(68, 45, 63, 14);
		...
		textField.setBounds(225, 43, 114, 20);
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							...
							java.sql.ResultSet rs = obj.querryupdatea(textField
									.getText());
