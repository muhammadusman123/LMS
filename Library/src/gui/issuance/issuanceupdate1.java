 ...
 *
 */
public class issuanceupdate1 extends JDialog {
	 ...
	 * 
	 */
	public issuanceupdate1() throws Exception {
		setResizable(false);
		...
		lblStudentid.setBounds(79, 48, 63, 14);
		...
		textField.setBounds(223, 47, 127, 20);
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent arg0) {
						...
						try {
							...
							obj.querryupdatea(issuanceid);
							if (issuancealgo.founder == 1) {
								issuancealgo.founder = 0;
								issuanceupdate2 obj3 = new issuanceupdate2(id);
								obj3.setVisible(true);
								obj.set(obj3, issuanceid);
								dispose();
							}
